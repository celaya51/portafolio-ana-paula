...
const translations = {
  es: {
    ...
    projectTitleNativa: 'Nativa Diseño de Branding y Redes Sociales',
    projectBrandingSocial: 'branding y redes sociales',
    ...
    projectDigitalCampaign: 'Diseño de Campaña Digital',
  ...
  en: {
    ...
    projectTitleNativa: 'Nativa Branding and Social Media Design',
    projectBrandingSocial: 'branding and social media',
    ...
    projectDigitalCampaign: 'Digital Campaign Design',
